(() => {
    var e = {
                ...
                document.addEventListener("DOMContentLoaded", (function() {
                    var e = {
                        ...
                        load: function() {
                            ...
                            }), e.updateDimensions(), e.wheel.image.onload = function() {
                                e.wheel.draw(), e.calculate({
                                    x: e.size - e.markers.outerRadius - 5,
                                    y: e.center
                                }, 0)
                            }, e.wheel.image.src = "../images/color-wheel.webp", document.querySelector("#picker").addEventListener("mousedown", e.drag.down), document.querySelector("#picker").addEventListener("touchstart", e.drag.down, {
                                passive: !1
                            }), document.body.addEventListener("mouseup", e.drag.up), document.body.addEventListener("touchend", e.drag.up, {
                                passive: !0
                            }), document.body.addEventListener("mousemove", e.drag.move), document.body.addEventListener("touchmove", e.drag.move, {
                                passive: !1
                            }), window.addEventListener("resize", e.reinitialize)
                        },
                        reinitialize: function() {
                            e.updateDimensions(), e.clearCanvas(), e.wheel.draw(), e.markers.draw(), e.calculate({
                        ...
                        updateDimensions: function() {
                            ...
                            e.size = t, e.center = e.size / 2, e.wheel.size = e.size - e.markers.outerSize, e.wheel.radius = e.wheel.size / 2, e.markers.outerRadius = e.markers.outerSize / 2, e.markers.innerRadius = e.markers.innerSize / 2, e.canvas.width = e.size, e.canvas.height = e.size, e.markers.list.forEach((function(t) {
                                t.x = Math.min(Math.max(t.x, e.markers.outerRadius), e.size - e.markers.outerRadius), t.y = Math.min(Math.max(t.y, e.markers.outerRadius), e.size - e.markers.outerRadius)
                            })), e.clearCanvas(), e.wheel.draw(), e.markers.draw()
                        },
                        ...
                        markers: {
                            ...
                            draw: function() {
                                ...
                                for (t = e.markers.list.length - 1; t >= 0; t--) {
                                    var l, d;
                                    if (e.markers.selected != t) e.markers.drawCircle((null === (l = e.colors.list[t]) || void 0 === l ? void 0 : l.str) || "#000", e.markers.list[t], e.markers.innerRadius);
                                    else(o = e.markers.list[t]).color = (null === (d = e.colors.list[t]) || void 0 === d ? void 0 : d.str) || "#000"
                                }
                                o && (e.markers.drawCircle("#FFF", o, e.markers.outerRadius), e.markers.drawCircle(o.color, o, e.markers.innerRadius))
                            },
                            drawContainer: function(t, r, n, s, i) {
                                e.context.fillStyle = "rgba(255, 255, 255, 0.5)", e.context.beginPath(), e.context.moveTo(e.center, e.center), e.context.arc(t.x, t.y, r, n, s, i), e.context.lineTo(e.center, e.center), e.context.fill(), e.context.closePath()
                            },
                            drawCircle: function(t, r, n) {
                                e.context.fillStyle = t, e.context.beginPath(), e.context.arc(r.x, r.y, n, 0, 2 * Math.PI), e.context.fill(), e.context.closePath()
                            }
                        },
                        drag: {
                            markerDragging: -1,
                            down: function(t) {
                                ...
                                var r = t.touches ? t.touches[0] : t,
                                    ...
                                    o = (r.clientY - n.top) * i;
                                if (e.drag.intersects(a, o, e.markers.list[e.markers.selected])) e.drag.markerDragging = e.markers.selected;
                                else
                                    for (var l = e.markers.list.length - 1; l >= 0; l--)
                                        if (e.drag.intersects(a, o, e.markers.list[l])) {
                                            var d, c;
                                            e.markers.selected = l, null === (d = document.querySelector(".samples .col.selected")) || void 0 === d || d.classList.remove("selected"), null === (c = document.querySelector('.samples .col[data-sample="'.concat(l, '"]'))) || void 0 === c || c.classList.add("selected"), e.drag.markerDragging = l;
                                            break
                                        } e.drag.move(t)
                            },
                            up: function() {
                        ...
                        calculate: function(t, r) {
                            var n;
                            if (e.clearCanvas(), e.wheel.draw(), 255 != e.context.getImageData(t.x, t.y, 1, 1).data[3]) {
                            ...
                            if (Math.sqrt(Math.pow(t.x - e.center, 2) + Math.pow(t.y - e.center, 2)) > e.wheel.radius) {
                                ...
                                t.x = e.center + e.wheel.radius * Math.cos(a), t.y = e.center + e.wheel.radius * Math.sin(a)
                            }
                            switch (null === (n = document.querySelector(".rules li.active")) || void 0 === n ? void 0 : n.dataset.type) {
                                case "1":
                                    e.points.analogous(t, r), e.colors.analogous();
                                    break;
                                case "2":
                                    e.points.monochromatic(t, r), e.colors.monochromatic();
                                    break;
                                case "3":
                                    e.points.triad(t, r), e.colors.triad();
                                    break;
                                case "4":
                                    e.points.complementary(t, r), e.colors.complementary();
                                    break;
                                case "5":
                                    e.points.custom(t, r), e.colors.custom(r)
                            }
                            for (r = 0; r < 5; r++) {
                                var o = document.querySelector('.samples > div[data-sample="'.concat(r, '"]'));
                                o && e.colors.list[r] && (o.querySelector(".hex").style.color = e.colors.list[r].str, o.querySelector(".rgb.r").value = e.colors.list[r].r, o.querySelector(".rgb.g").value = e.colors.list[r].g, o.querySelector(".rgb.b").value = e.colors.list[r].b, o.querySelector(".hex").value = "#" + e.calc.rgbToHex(e.colors.list[r].r, e.colors.list[r].g, e.colors.list[r].b))
                            }
                            e.markers.draw()
                        },
                        fromColor: function(t, r) {
                            ...
                            o.x += e.center, o.y += e.center, e.calculate(o, r)
                        },
                        points: {
                            analogous: function(t, r) {
                                e.markers.list = [];
                                var n = t;
                                1 == r ? n = e.calc.rotate(t, e.calc.degToRad(15)) : 2 == r ? n = e.calc.rotate(t, e.calc.degToRad(-15)) : 3 == r ? n = e.calc.rotate(t, e.calc.degToRad(30)) : 4 == r && (n = e.calc.rotate(t, e.calc.degToRad(-30))), e.markers.list[0] = n, e.markers.list[1] = e.calc.rotate(n, e.calc.degToRad(-15)), e.markers.list[2] = e.calc.rotate(n, e.calc.degToRad(15)), e.markers.list[3] = e.calc.rotate(n, e.calc.degToRad(-30)), e.markers.list[4] = e.calc.rotate(n, e.calc.degToRad(30))
                            },
                            monochromatic: function(t, r) {
                                e.markers.list = [];
                                var n, s, i = e.wheel.radius / 190 * 58;
                                0 == r || 3 == r || 4 == r ? (n = t, s = e.calc.extend(n, -i)) : 1 != r && 2 != r || (s = t, n = e.calc.extend(s, i)), e.markers.list[0] = n, e.markers.list[1] = s, e.markers.list[2] = s, e.markers.list[3] = n, e.markers.list[4] = n, e.markers.list.forEach((function(t, r) {
                                    ...
                                    if (Math.sqrt(Math.pow(t.x - e.center, 2) + Math.pow(t.y - e.center, 2)) > e.wheel.radius) {
                                        ...
                                        t.x = e.center + e.wheel.radius * Math.cos(i), t.y = e.center + e.wheel.radius * Math.sin(i)
                                    }
                                    e.markers.list[r] = t
                                }))
                            },
                            triad: function(t, r) {
                                var n, s, i;
                                e.markers.list = [], 0 != r && 3 != r || (n = t, s = e.calc.rotate(n, e.calc.degToRad(-120)), i = e.calc.rotate(n, e.calc.degToRad(120))), 1 == r ? (n = e.calc.rotate(t, e.calc.degToRad(120)), s = t, i = e.calc.rotate(n, e.calc.degToRad(120))) : 2 != r && 4 != r || (n = e.calc.rotate(t, e.calc.degToRad(-120)), s = e.calc.rotate(n, e.calc.degToRad(-120)), i = t), e.markers.list[0] = n, e.markers.list[1] = s, e.markers.list[2] = i, e.markers.list[3] = n, e.markers.list[4] = i
                            },
                            complementary: function(t, r) {
                                var n, s, i;
                                e.markers.list = [], 0 == r || 3 == r ? (n = t, s = e.calc.extend(t, -e.markers.outerSize), i = e.calc.rotate(n, Math.PI)) : 1 == r ? (n = e.calc.extend(t, e.markers.outerSize), s = t, i = e.calc.rotate(n, Math.PI)) : 2 != r && 4 != r || (n = e.calc.rotate(t, Math.PI), s = e.calc.extend(n, -e.markers.outerRadius), i = t), e.markers.list[0] = n, e.markers.list[1] = s, e.markers.list[2] = i, e.markers.list[3] = n, e.markers.list[4] = i, e.markers.list.forEach((function(t, r) {
                                    if (255 != e.context.getImageData(t.x, t.y, 1, 1).data[3]) {
                                        var n = Math.sqrt(Math.pow(t.x - e.center, 2) + Math.pow(t.y - e.center, 2)),
                                            s = e.center - e.markers.outerRadius - 1 - n;
                                        t = e.calc.extend(t, s)
                        ...
                        colors: {
                            ...
                            analogous: function() {
                                for (var t = 0; t < e.markers.list.length; t++) {
                                    ...
                                    if (1 == t || 2 == t) {
                                        var n = 255 * (1 - .91);
                                        r[0] -= n, r[0] = r[0] < 0 ? 0 : r[0], r[1] -= n, r[1] = r[1] < 0 ? 0 : r[1], r[2] -= n, r[2] = r[2] < 0 ? 0 : r[2]
                                    }
                                    e.colors.list[t] = {
                                        r: r[0],
                                        g: r[1],
                        ...
                        calc: {
                            ...
                            extend: function(t, r) {
                                var n = t.x - e.center,
                                    ...
                                    a = Math.PI;
                                if (0 != n) a = Math.atan(s / n) + (n >= 0 ? 0 : Math.PI);
                                return {
                            ...
                            rgbToHsl: function(e, t, r) {
                                e /= 255, t /= 255, r /= 255;
                                var n, s, i = Math.max(e, t, r),
                                    a = Math.min(e, t, r),
                                    o = (i + a) / 2;
                                if (i == a) n = s = 0;
                                else {
                                    var l = i - a;
                                    switch (s = o > .5 ? l / (2 - i - a) : l / (i + a), i) {
                                        case e:
                                            n = (t - r) / l + (t < r ? 6 : 0);
                                            break;
                                        case t:
                    ...
                    e.load(), document.querySelectorAll(".rules li").forEach((function(t) {
                        t.addEventListener("click", (function() {
                            var t = document.querySelector(".rules li.active");
                            this !== t && (t.classList.remove("active"), this.classList.add("active"), e.calculate({
                                x: e.markers.list[e.markers.selected].x,
                                y: e.markers.list[e.markers.selected].y
                            }, e.markers.selected))
                        }))
                        ...
                        t.addEventListener("click", (function() {
                            ...
                            t !== r && (r.classList.remove("selected"), t.classList.add("selected"), e.markers.selected = t.dataset.sample, e.clearCanvas(), e.wheel.draw(), e.markers.draw())
                        }))
                        ...
                        t.addEventListener("change", (function(t) {
                            var r = this,
                                ...
                                i = 0,
                                a = 0;
                            r.classList.contains("r") ? (s = parseInt(r.value), i = parseInt(r.closest(".col").querySelector(".g").value), a = parseInt(r.closest(".col").querySelector(".b").value)) : r.classList.contains("g") ? (s = parseInt(r.closest(".col").querySelector(".r").value), i = parseInt(r.value), a = parseInt(r.closest(".col").querySelector(".b").value)) : (s = parseInt(r.closest(".col").querySelector(".r").value), i = parseInt(r.closest(".col").querySelector(".g").value), a = parseInt(r.value)), isNaN(s) || isNaN(i) || isNaN(a) ? t.preventDefault() : e.fromColor({
                                r: s,
                                g: i,
                                b: a
                            }, n)
            ...
            560: () => {
                document.addEventListener("DOMContentLoaded", (function() {
                    ...
                    a.addEventListener("touchstart", (function(e) {
                        r = e.touches[0].clientY, s = e.touches[0].clientX
                    }), {
                        passive: !0
                    }), a.addEventListener("touchend", (function(e) {
                        n = e.changedTouches[0].clientY, i = e.changedTouches[0].clientX, (n - r > 50 || i - s > 50) && document.body.classList.remove("menu-open")
                    }), {
                        passive: !0
                    });
                    ...
                    d.addEventListener("touchstart", (function(e) {
                        ...
                        l = e.changedTouches[0].clientX, o - l > 50 && document.body.classList.add("menu-open")
                    }), {
                        passive: !0
                    })
                }))
            ...
            828: () => {
                document.addEventListener("DOMContentLoaded", (function() {
                    function e(e) {
                        e.classList.add("closing"), setTimeout((function() {
                    ...
                    document.addEventListener("pageClosed", (function(e) {
                        ...
                        "#interactions" == e.detail ? i.classList.add("disabled") : i.classList.remove("disabled"), "#about" == e.detail ? s.classList.add("disabled") : s.classList.remove("disabled")
                    }));
                    var n = document.querySelector(".pages");
                    document.addEventListener("keydown", (function(e) {
                        n.open && (39 == e.keyCode && t(), 37 == e.keyCode && r())
                        ...
                        document.dispatchEvent(new CustomEvent("pageClosed", {
                            detail: t
                        })), history.replaceState("", document.title, window.location.pathname + window.location.search), e(n), setTimeout((function() {
                    ...
                    i.addEventListener("click", (function() {
                        ...
                        new IntersectionObserver((function(e) {
                            e.forEach((function(e) {
                                e.isIntersecting ? (e.target.classList.add("open"), history.replaceState("", document.title, window.location.pathname + window.location.search + "#" + e.target.id), document.dispatchEvent(new CustomEvent("pageOpend", {
                                    detail: "#" + e.target.id
                                }))) : (e.target.querySelector(".container").scroll({
                                    top: 0
                                }), e.target.classList.remove("open"), document.dispatchEvent(new CustomEvent("pageClosed", {
                                    detail: e.target
                                })))
                            }))
                        }), {
                        ...
                        e.addEventListener("scroll", (function() {
                            e.scrollTop > e.clientHeight / 2 ? (t.classList.add("scrolled-down"), document.dispatchEvent(new CustomEvent("scrolled-down", {
                                detail: t
                            }))) : t.classList.contains("scrolled-down") && (t.classList.remove("scrolled-down"), document.dispatchEvent(new CustomEvent("scrolled-up", {
                                detail: t
                            })))
                        }))
                    }));
                    ...
                    if (a) {
                        ...
                        o && document.addEventListener("loading-complete", (function() {
                            n.showModal(), n.scroll({
                                left: o.offsetLeft
                            }), document.dispatchEvent(new CustomEvent("pageOpend", {
                                detail: a
                            })), document.body.classList.add("menu-open"), o.classList.add("open")
                        }))
                    }
                    window.addEventListener("popstate", (function() {
                        ...
                        } else e(n), document.querySelector("body").classList.remove("menu-open"), document.querySelectorAll(".page.open").forEach((function(e) {
                            e.classList.remove("open"), e.classList.remove("scrolled-down"), document.dispatchEvent(new CustomEvent("pageClosed", {
                                detail: e
                            }))
                        }))
                        ...
                        document.querySelectorAll(".avatar video").forEach((function(e) {
                            if ("visible" === document.visibilityState && null != e && e.paused) {
                                var t = function() {
                                    ...
                                    })), document.removeEventListener("touchstart", t), document.removeEventListener("click", t)
                                };
            ...
            807: () => {
                ...
                document.addEventListener("DOMContentLoaded", (function() {
                    ...
                    "light" === r ? (document.body.classList.add("light-theme"), e.checked = !0) : (document.body.classList.remove("light-theme"), e.checked = !1), t(r), e.addEventListener("change", (function() {
                        var e = this.checked ? "light" : "dark";
                        document.body.classList.toggle("light-theme", "light" === e), localStorage.setItem("theme", e), t(e)
                    }))
                }))
            },
            319: () => {
                document.addEventListener("DOMContentLoaded", (function() {
                    ...
                    function n() {
                        ...
                        if (!t) {
                            t = !0;
                            var i = e;
                            r[i].classList.remove("active"), r[i].classList.add("exiting"), setTimeout((function() {
                                return r[i].classList.remove("exiting")
                            }), 800), e = (e + 1) % r.length, setTimeout((function() {
                                r[e].classList.add("active")
                            }), 20), n.textContent = "Font Pair: ".concat(r[e].dataset.font), s.style.transform = "rotate(".concat(90 * e, "deg)"), setTimeout((function() {
                                return t = !1
                            }), 800)
                        }
                    }
    ...
    function r(n) {
        ...
        function c(e, t) {
            ...
            function h(e) {
                var r = t ? t * e / 1e3 : e;
                return r = p < 1 ? Math.exp(-r * p * u) * (1 * Math.cos(f * r) + m * Math.sin(f * r)) : (1 + m * r) * Math.exp(-r * u), 0 === e || 1 === e ? e : 1 - r
            }
            return t ? h : function() {
                var t = s.springs[e];
                if (t) return t;
        ...
        var p, f, m = function() {
                ...
                return function(t, r, n, a) {
                    if (0 <= t && t <= 1 && 0 <= n && n <= 1) {
                        ...
                        if (t !== r || n !== a)
                            for (var l = 0; l < 11; ++l) o[l] = s(l * e, t, n);
                        return function(e) {
                    ...
                    function d(r) {
                        for (var a = 0, l = 1; 10 !== l && o[l] <= r; ++l) a += e;
                        --l;
            ...
            h = (p = {
                ...
                var t = f[e];
                p["easeIn" + e] = t, p["easeOut" + e] = function(e, r) {
                    return function(n) {
                        return 1 - t(e, r)(1 - n)
                    }
        ...
        function E(e, t) {
            var r = T(e);
            for (var n in t) r[n] = l.und(e[n]) ? t[n] : e[n];
            return r
        }
        ...
        function M(e) {
            return l.rgb(e) ? (r = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(t = e)) ? "rgba(" + r[1] + ",1)" : t : l.hex(e) ? function(e) {
                ...
                var t, r, n, s = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(e) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(e),
                ...
                if (0 == a) t = r = n = o;
                    ...
                    var c = o < .5 ? o * (1 + a) : o + a - o * a,
                        u = 2 * o - c;
                    t = d(u, c, i + 1 / 3), r = d(u, c, i), n = d(u, c, i - 1 / 3)
                }
        ...
        function A(e) {
            if (l.dom(e)) {
                for (var t, r = e.style.transform || "", n = /(\w+)\(([^)]*)\)/g, s = new Map; t = n.exec(r);) s.set(t[1], t[2]);
                return s
            }
        }
        ...
        function z(e, t, r, n) {
            var s = a(t, "scale") ? 1 : 0 + function(e) {
                ...
                i = A(e).get(t) || s;
            return r && (r.transforms.list.set(t, i), r.transforms.last = t), n ? P(e, i, n) : i
        }
        ...
        function j(e, t) {
            var r = T(t);
            if (/^spring/.test(r.easing) && (r.duration = c(r.easing)), l.arr(e)) {
                var n = e.length;
                2 === n && !l.obj(e[0]) ? e = {
                    value: e
            ...
            return s.map((function(e, r) {
                ...
                return l.und(n.delay) && (n.delay = r ? 0 : t.delay), l.und(n.endDelay) && (n.endDelay = r === s.length - 1 ? t.endDelay : 0), n
            })).map((function(e) {
                return E(e, r)
            }))
        }
            ...
            for (var s in n && (t = E(function(e) {
                    for (var t = w(y(e.map((function(e) {
                            ...
                            r[s] = e.map((function(e) {
                                var t = {};
                                for (var r in e) l.key(r) ? r == s && (t.value = e[r]) : t[r] = e[r];
                                return t
                            }))
                        }, s = 0; s < t.length; s++) n(s);
                    return r
                }(n), t)), t) l.key(s) && r.push({
                name: s,
                tweens: j(t[s], e)
            });
            return r
        ...
        function X(e, t) {
            ...
            return e.tweens.map((function(n) {
                var s = function(e, t) {
                    ...
                    p = k(u) || k(d),
                    f = o || p;
                return l.und(a) && (a = c), s.from = V(u, f), s.to = V(q(a, u), f), s.start = r ? r.end : 0, s.end = s.start + s.delay + s.duration + s.endDelay, s.easing = v(s.easing, s.duration), s.isPath = l.pth(i), s.isPathTargetInsideSVG = s.isPath && l.svg(t.target), s.isColor = l.col(s.from.original), s.isColor && (s.round = 1), r = s, s
            }))
        }
        var Y = {
            css: function(e, t, r) {
        ...
        function Z(e, t) {
            ...
            }))) : t.duration, s.delay = r ? Math.min.apply(Math, e.map((function(e) {
                return n(e) + e.delay
            }))) : t.delay, s.endDelay = r ? s.duration - Math.max.apply(Math, e.map((function(e) {
            ...
            ee = function() {
                ...
                function t(r) {
                    for (var n = J.length, s = 0; s < n;) {
                        var i = J[s];
                        i.paused ? (J.splice(s, 1), n--) : (i.tick(r), s++)
                    }
        ...
        function re(r) {
            ...
            function p() {
                var e = u.direction;
                "alternate" !== e && (u.direction = "normal" !== e ? "normal" : "reverse"), u.reversed = !u.reversed, n.forEach((function(e) {
            ...
            function m() {
                s = 0, a = f(u.currentTime) * (1 / re.speed)
            }
            ...
            function v(e) {
                for (var t = 0, r = u.animations, n = r.length; t < n;) {
                    ...
                    for (var c = i(e - d.start - d.delay, 0, d.duration) / d.duration, p = isNaN(c) ? 1 : d.easing(c), f = d.to.strings, m = d.round, h = [], v = d.to.numbers.length, g = void 0, y = 0; y < v; y++) {
                        ...
                        b = d.isPath ? F(d.value, p * S, d.isPathTargetInsideSVG) : T + p * (S - T), m && (d.isColor && y > 2 || (b = Math.round(b * m) / m)), h.push(b)
                    }
                    var x = f.length;
                    if (x) {
                        g = f[0];
                    ...
                    Y[s.type](a.target, s.property, g, a.transforms), s.currentValue = g, t++
                }
            }
            ...
            function y(e) {
                var t = u.duration,
                    ...
                    m = t - u.endDelay,
                    w = f(e);
                u.progress = i(w / t * 100, 0, 100), u.reversePlayback = w < u.currentTime, n && function(e) {
                    if (u.reversePlayback)
                        for (var t = l; t--;) h(e, n[t]);
                    else
                        for (var r = 0; r < l; r++) h(e, n[r])
                }(w), !u.began && u.currentTime > 0 && (u.began = !0, g("begin")), !u.loopBegan && u.currentTime > 0 && (u.loopBegan = !0, g("loopBegin")), w <= r && 0 !== u.currentTime && v(0), (w >= m && u.currentTime !== t || !t) && v(t), w > r && w < m ? (u.changeBegan || (u.changeBegan = !0, u.changeCompleted = !1, g("changeBegin")), g("change"), v(w)) : u.changeBegan && (u.changeCompleted = !0, u.changeBegan = !1, g("changeComplete")), u.currentTime = i(w, 0, t), u.began && g("update"), e >= t && (a = 0, u.remaining && !0 !== u.remaining && u.remaining--, u.remaining ? (s = o, g("loopComplete"), u.loopBegan = !1, "alternate" === u.direction && p()) : (u.paused = !0, u.completed || (u.completed = !0, g("loopComplete"), g("complete"), !u.passThrough && "Promise" in window && (d(), c(u)))))
            }
            return u.reset = function() {
                var e = u.direction;
                u.passThrough = !1, u.currentTime = 0, u.progress = 0, u.paused = !0, u.began = !1, u.loopBegan = !1, u.changeBegan = !1, u.completed = !1, u.changeCompleted = !1, u.reversePlayback = !1, u.reversed = "reverse" === e, u.remaining = u.loop, n = u.children;
                for (var t = l = n.length; t--;) u.children[t].reset();
                (u.reversed && !0 !== u.loop || "alternate" === e && 1 === u.loop) && u.remaining++, v(u.reversed ? u.duration : 0)
            }, u._onDocumentVisibility = m, u.set = function(e, t) {
                return U(e, t), u
            }, u.tick = function(e) {
                o = e, s || (s = o), y((o + (a - s)) * re.speed)
            }, u.seek = function(e) {
                y(f(e))
            }, u.pause = function() {
                u.paused = !0, m()
            }, u.play = function() {
                u.paused && (u.completed && u.reset(), u.paused = !1, J.push(u), m(), ee())
            }, u.reverse = function() {
                p(), u.completed = !u.reversed, m()
            }, u.restart = function() {
                u.reset(), u.play()
            }, u.remove = function(e) {
                se($(e), u)
        ...
        function ne(e, t) {
            for (var r = t.length; r--;) S(e, t[r].animatable.target) && t.splice(r, 1)
        }
        ...
        function se(e, t) {
            ...
            for (var s = n.length; s--;) {
                var i = n[s],
                    a = i.animations;
                ne(e, a), a.length || i.children.length || n.splice(s, 1)
            }
            r.length || n.length || t.pause()
        }
        re.version = "3.2.1", re.speed = 1, re.suspendWhenDocumentHidden = !0, re.running = J, re.remove = function(e) {
            for (var t = $(e), r = J.length; r--;) {
                se(t, J[r])
            }
        }, re.get = D, re.set = U, re.convertPx = P, re.path = function(e, t) {
            ...
            return function(e, t, l) {
                if (o && (a = 0), d && (a = (l - 1) / 2), c && (a = l - 1), !g.length) {
                    for (var v = 0; v < l; v++) {
                        if (s) {
                            var y = d ? (s[0] - 1) / 2 : a % s[0],
                                ...
                                x = Math.sqrt(S * S + T * T);
                            "x" === i && (x = -S), "y" === i && (x = -T), g.push(x)
                        } else g.push(Math.abs(a - v));
            ...
            void 0 === e && (e = {});
            var r = re(e);
            return r.duration = 0, r.add = function(n, s) {
                var i = J.indexOf(r),
                    a = r.children;
                ...
                var u = r.duration;
                c.autoplay = !1, c.direction = r.direction, c.timelineOffset = l.und(s) ? u : q(s, u), o(r), r.seek(c.timelineOffset);
                var p = re(c);
                o(p), a.push(p);
                var f = Z(a, e);
                return r.delay = f.delay, r.endDelay = f.endDelay, r.duration = f.duration, r.seek(0), r.reset(), r.autoplay && r.play(), r
            }, r
        }, re.easing = v, re.penner = h, re.random = function(e, t) {
            return Math.floor(Math.random() * (t - e + 1)) + e
        };
        const ie = re;
        document.querySelectorAll(".anim-letters").forEach((function(e) {
            e.style.opacity = 1, e.innerHTML = e.textContent.replace(/(\S+)/g, "<span class='word'>$&</span>")
            ...
            for (let n = 1; n < arguments.length; n += 1) {
                ...
                if (null != s && (r = s, !("undefined" != typeof window && void 0 !== window.HTMLElement ? r instanceof HTMLElement : r && (1 === r.nodeType || 11 === r.nodeType)))) {
                    ...
                    for (let t = 0, n = r.length; t < n; t += 1) {
                        ...
                        void 0 !== i && i.enumerable && (ve(e[n]) && ve(s[n]) ? s[n].__swiper__ ? e[n] = s[n] : ge(e[n], s[n]) : !ve(e[n]) && ve(s[n]) ? (e[n] = {}, s[n].__swiper__ ? e[n] = s[n] : ge(e[n], s[n])) : e[n] = s[n])
                    }
                }
            }
            var r;
        ...
        function ye(e) {
            ...
            const d = r > i ? "next" : "prev",
                ...
                u = () => {
                    ...
                    let p = i + d * (r - i);
                    if (c(p, r) && (p = r), t.wrapperEl.scrollTo({
                            [n]: p
                        }), c(p, r)) return t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
        ...
        function Oe(e) {
            return void 0 === e && (e = {}), Ce || (Ce = function(e) {
                let {
                    userAgent: t
                } = void 0 === e ? {} : e;
                const r = Ie(),
                ...
                const u = i.match(/(iPod)(.*OS\s([\d_]+))?/),
                    ...
                    f = "Win32" === s;
                let m = "MacIntel" === s;
                return !c && m && r.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = i.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), d && !f && (a.os = "android", a.android = !0), (c || p || u) && (a.os = "ios", a.ios = !0), a
            }(e)), Ce
        }
            ...
            Be = e => {
                ...
                if (e.params.rewind || e.params.loop)
                    for (let n = s - t; n <= i + t; n += 1) {
                        ...
                        for (let n = Math.max(s - t, 0); n <= Math.min(i + t, r - 1); n += 1) n !== s && (n > i || n < s) && Re(e, n)
            };
        var Ne = {
            updateSize: function() {
                const e = this;
                let t, r;
                const n = e.el;
                t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : n.clientWidth, r = void 0 !== e.params.height && null !== e.params.height ? e.params.height : n.clientHeight, 0 === t && e.isHorizontal() || 0 === r && e.isVertical() || (t = t - parseInt(Ee(n, "padding-left") || 0, 10) - parseInt(Ee(n, "padding-right") || 0, 10), r = r - parseInt(Ee(n, "padding-top") || 0, 10) - parseInt(Ee(n, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(r) && (r = 0), Object.assign(e, {
                    width: t,
                    height: r,
            ...
            updateSlides: function() {
                ...
                let y = r.spaceBetween,
                    ...
                    T = 0;
                if (void 0 === i) return;
                "string" == typeof y && y.indexOf("%") >= 0 ? y = parseFloat(y.replace("%", "")) / 100 * i : "string" == typeof y && (y = parseFloat(y)), e.virtualSize = -y, c.forEach((e => {
                ...
                for (let n = 0; n < u; n += 1) {
                    let s;
                    if (E = 0, c[n] && (s = c[n]), x && e.grid.updateSlide(n, s, c), !c[n] || "none" !== Ee(s, "display")) {
                        if ("auto" === r.slidesPerView) {
                            M && (c[n].style[e.getDirectionLabel("width")] = "");
                            const i = getComputedStyle(s),
                                a = s.style.transform,
                                o = s.style.webkitTransform;
                            if (a && (s.style.transform = "none"), o && (s.style.webkitTransform = "none"), r.roundLengths) E = e.isHorizontal() ? ke(s, "width", !0) : ke(s, "height", !0);
                            else {
                                const e = t(i, "width"),
                                    r = t(i, "padding-left"),
                                    n = t(i, "padding-right"),
                            ...
                            a && (s.style.transform = a), o && (s.style.webkitTransform = o), r.roundLengths && (E = Math.floor(E))
                        } else E = (i - (r.slidesPerView - 1) * y) / r.slidesPerView, r.roundLengths && (E = Math.floor(E)), c[n] && (c[n].style[e.getDirectionLabel("width")] = `${E}px`);
                        c[n] && (c[n].swiperSlideSize = E), m.push(E), r.centeredSlides ? (b = b + E / 2 + S / 2 + y, 0 === S && 0 !== n && (b = b - i / 2 - y), 0 === n && (b = b - i / 2 - y), Math.abs(b) < .001 && (b = 0), r.roundLengths && (b = Math.floor(b)), T % r.slidesPerGroup == 0 && p.push(b), f.push(b)) : (r.roundLengths && (b = Math.floor(b)), (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && p.push(b), f.push(b), b = b + E + y), e.virtualSize += E + y, S = E, T += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, i) + v, a && o && ("slide" === r.effect || "coverflow" === r.effect) && (n.style.width = `${e.virtualSize+y}px`), r.setWrapperSize && (n.style[e.getDirectionLabel("width")] = `${e.virtualSize+y}px`), x && e.grid.updateWrapperSize(E, p), !r.centeredSlides) {
                    const t = [];
                    for (let n = 0; n < p.length; n += 1) {
                        let s = p[n];
                        r.roundLengths && (s = Math.floor(s)), p[n] <= e.virtualSize - i && t.push(s)
                    }
                ...
                if (Object.assign(e, {
                    ...
                    we(n, "--swiper-centered-offset-before", -p[0] + "px"), we(n, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                    const t = -e.snapGrid[0],
                        r = -e.slidesGrid[0];
                    e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + r))
                }
                if (u !== d && e.emit("slidesLengthChange"), p.length !== g && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== w && e.emit("slidesGridLengthChange"), r.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || r.cssMode || "slide" !== r.effect && "fade" !== r.effect)) {
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    h && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), De(l, h, r.slideVisibleClass), De(l, m, r.slideFullyVisibleClass), l.progress = s ? -c : c, l.originalProgress = s ? -u : u
                }
            },
            updateProgress: function(e) {
                ...
                Object.assign(t, {
                    ...
                    isBeginning: i,
                    isEnd: a
                }), (r.watchSlidesProgress || r.centeredSlides && r.autoHeight) && t.updateSlidesProgress(e), i && !l && t.emit("reachBeginning toEdge"), a && !d && t.emit("reachEnd toEdge"), (l && !i || d && !a) && t.emit("fromEdge"), t.emit("progress", s)
            },
            updateSlidesClasses: function() {
                ...
                else a ? (l = t.find((e => e.column === s)), c = t.find((e => e.column === s + 1)), d = t.find((e => e.column === s - 1))) : l = t[s];
                l && (a || (c = function(e, t) {
                    const r = [];
                    ...
                    qe(e, e === l, r.slideActiveClass), qe(e, e === c, r.slideNextClass), qe(e, e === d, r.slidePrevClass)
                })), e.emitSlidesClasses()
            },
            updateActiveIndex: function(e) {
                ...
                if (l >= n.length && (l = n.length - 1), d === i && !t.params.loop) return void(l !== o && (t.snapIndex = l, t.emit("snapIndexChange")));
                ...
                Object.assign(t, {
                    ...
                    previousIndex: i,
                    activeIndex: d
                }), t.initialized && Be(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (a !== p && t.emit("realIndexChange"), t.emit("slideChange"))
            },
            updateClickedSlide: function(e, t) {
                ...
                r.clickedSlide = s, r.virtual && r.params.virtual.enabled ? r.clickedIndex = parseInt(s.getAttribute("data-swiper-slide-index"), 10) : r.clickedIndex = i, n.slideToClickedSlide && void 0 !== r.clickedIndex && r.clickedIndex !== r.activeIndex && r.slideToClickedSlide()
            }
        };
        var _e = {
            ...
            setTranslate: function(e, t) {
                ...
                let o, l = 0,
                    d = 0;
                r.isHorizontal() ? l = n ? -e : e : d = e, s.roundLengths && (l = Math.floor(l), d = Math.floor(d)), r.previousTranslate = r.translate, r.translate = r.isHorizontal() ? l : d, s.cssMode ? i[r.isHorizontal() ? "scrollLeft" : "scrollTop"] = r.isHorizontal() ? -l : -d : s.virtualTranslate || (r.isHorizontal() ? l -= r.cssOverflowAdjustment() : d -= r.cssOverflowAdjustment(), i.style.transform = `translate3d(${l}px, ${d}px, 0px)`);
            ...
            translateTo: function(e, t, r, n, s) {
                ...
                const l = i.minTranslate(),
                    d = i.maxTranslate();
                let c;
                if (c = n && e > l ? l : n && e < d ? d : e, i.updateProgress(c), a.cssMode) {
                    const e = i.isHorizontal();
                    if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
                    else {
                        if (!i.support.smoothScroll) return ye({
                            swiper: i,
                            targetPosition: -c,
                            side: e ? "left" : "top"
                        }), !0;
                ...
                return 0 === t ? (i.setTransition(0), i.setTranslate(c), r && (i.emit("beforeTransitionStart", t, s), i.emit("transitionEnd"))) : (i.setTransition(t), i.setTranslate(c), r && (i.emit("beforeTransitionStart", t, s), i.emit("transitionStart")), i.animating || (i.animating = !0, i.onTranslateToWrapperTransitionEnd || (i.onTranslateToWrapperTransitionEnd = function(e) {
                    i && !i.destroyed && e.target === this && (i.wrapperEl.removeEventListener("transitionend", i.onTranslateToWrapperTransitionEnd), i.onTranslateToWrapperTransitionEnd = null, delete i.onTranslateToWrapperTransitionEnd, i.animating = !1, r && i.emit("transitionEnd"))
        ...
        var Ve = {
            slideTo: function(e, t, r, n, s) {
                ...
                if (!m && !n && !s || i.destroyed || i.animating && o.preventInteractionOnTransition) return !1;
                ...
                if (i.initialized && a !== u) {
                    ...
                    if (!i.allowSlidePrev && g > i.translate && g > i.maxTranslate() && (u || 0) !== a) return !1
                }
                let w;
                a !== (c || 0) && r && i.emit("beforeSlideChangeStart"), i.updateProgress(g), w = a > u ? "next" : a < u ? "prev" : "reset";
                const y = i.virtual && i.params.virtual.enabled;
                if (!(y && s) && (p && -g === i.translate || !p && g === i.translate)) return i.updateActiveIndex(a), o.autoHeight && i.updateAutoHeight(), i.updateSlidesClasses(), "slide" !== o.effect && i.setTranslate(g), "reset" !== w && (i.transitionStart(r, w), i.transitionEnd(r, w)), !1;
                if (o.cssMode) {
                    const e = i.isHorizontal(),
                        r = p ? g : -g;
                    if (0 === t) y && (i.wrapperEl.style.scrollSnapType = "none", i._immediateVirtual = !0), y && !i._cssModeVirtualInitialSet && i.params.initialSlide > 0 ? (i._cssModeVirtualInitialSet = !0, requestAnimationFrame((() => {
                        f[e ? "scrollLeft" : "scrollTop"] = r
                    }))) : f[e ? "scrollLeft" : "scrollTop"] = r, y && requestAnimationFrame((() => {
                ...
                return i.setTransition(t), i.setTranslate(g), i.updateActiveIndex(a), i.updateSlidesClasses(), i.emit("beforeTransitionStart", t, n), i.transitionStart(r, w), 0 === t ? i.transitionEnd(r, w) : i.animating || (i.animating = !0, i.onSlideToWrapperTransitionEnd || (i.onSlideToWrapperTransitionEnd = function(e) {
                    i && !i.destroyed && e.target === this && (i.wrapperEl.removeEventListener("transitionend", i.onSlideToWrapperTransitionEnd), i.onSlideToWrapperTransitionEnd = null, delete i.onSlideToWrapperTransitionEnd, i.transitionEnd(r, w))
            ...
            slideToLoop: function(e, t, r, n) {
                ...
                if (s.params.loop)
                    if (s.virtual && s.params.virtual.enabled) a += s.virtual.slidesBefore;
                        ...
                        let l = t - e < o;
                        if (r && (l = l || e < Math.ceil(o / 2)), n && r && "auto" !== s.params.slidesPerView && !i && (l = !1), l) {
            ...
            slideNext: function(e, t, r) {
                ...
                if (i.loop) {
                    if (a && !d && i.loopPreventsSliding) return !1;
                    if (n.loopFix({
                            direction: "next"
                        }), n._clientLeft = n.wrapperEl.clientLeft, n.activeIndex === n.slides.length - 1 && i.cssMode) return requestAnimationFrame((() => {
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    s = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? i < e.loopedSlides - n / 2 || i > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), i = e.getSlideIndex(Se(r, `${a}[data-swiper-slide-index="${s}"]`)[0]), fe((() => {
                        e.slideTo(i)
                    }))) : e.slideTo(i) : i > e.slides.length - n ? (e.loopFix(), i = e.getSlideIndex(Se(r, `${a}[data-swiper-slide-index="${s}"]`)[0]), fe((() => {
                        e.slideTo(i)
                    }))) : e.slideTo(i)
                } else e.slideTo(i)
            }
        ...
        var $e = {
            ...
            loopFix: function(e) {
                ...
                if (l.__preventObserver__ = !0, requestAnimationFrame((() => {
                    ...
                    })), l.recalcSlides(), "auto" === f.slidesPerView ? l.updateSlides() : w && (y.length > 0 && x || b.length > 0 && T) && l.slides.forEach(((e, t) => {
                    ...
                    if (y.length > 0 && x) {
                        if (void 0 === t) {
                            ...
                            o ? l.setTranslate(l.translate - t) : (l.slideTo(S + Math.ceil(E), 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                        } else if (s) {
                    ...
                    if (void 0 === t) {
                        ...
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(S - M, 0, !1, !0), s && (l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - t, l.touchEventsData.currentTranslate = l.touchEventsData.currentTranslate - t))
                    } else {
        ...
        function He(e, t, r) {
            ...
            return !i || !(r <= a || r >= n.innerWidth - a) || "prevent" === i && (t.preventDefault(), !0)
        }
        ...
        function je(e) {
            ...
            if ("touchstart" === n.type) return void He(t, n, n.targetTouches[0].pageX);
            const {
                params: i,
                touches: a,
                enabled: o
            ...
            if (!o) return;
            if (!i.simulateTouch && "mouse" === n.pointerType) return;
            ...
            if ("wrapper" === i.touchEventsTarget && ! function(e, t) {
                    const r = pe();
                    let n = t.contains(e);
                    !n && r.HTMLSlotElement && t instanceof HTMLSlotElement && (n = [...t.assignedElements()].includes(e), n || (n = function(e, t) {
                        const r = [t];
                        for (; r.length > 0;) {
                            const t = r.shift();
                            if (e === t) return !0;
            ...
            Object.assign(s, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), a.startX = f, a.startY = m, s.touchStartTime = me(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, i.threshold > 0 && (s.allowThresholdMove = !1);
            let h = !0;
            l.matches(s.focusableElements) && (h = !1, "SELECT" === l.nodeName && (s.isTouched = !1)), r.activeElement && r.activeElement.matches(s.focusableElements) && r.activeElement !== l && ("mouse" === n.pointerType || "mouse" !== n.pointerType && !l.matches(s.focusableElements)) && r.activeElement.blur();
            const v = h && t.allowTouchMove && i.touchStartPreventDefault;
            !i.touchStartForcePreventDefault && !v || l.isContentEditable || n.preventDefault(), i.freeMode && i.freeMode.enabled && t.freeMode && t.animating && !i.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", n)
        }
        ...
        function We(e) {
            ...
            if ("touchmove" === d.type) {
                if (l = [...d.changedTouches].find((e => e.identifier === n.touchId)), !l || l.identifier !== n.touchId) return
            } else l = d;
            if (!n.isTouched) return void(n.startMoving && n.isScrolling && r.emit("touchMoveOpposite", d));
            const c = l.pageX,
                u = l.pageY;
            if (d.preventedByNestedSwiper) return i.startX = c, void(i.startY = u);
            if (!r.allowTouchMove) return d.target.matches(n.focusableElements) || (r.allowClick = !1), void(n.isTouched && (Object.assign(i, {
                startX: c,
                startY: u,
                currentX: c,
                currentY: u
            ...
            if (s.touchReleaseOnEdges && !s.loop)
                if (r.isVertical()) {
                    if (u < i.startY && r.translate <= r.maxTranslate() || u > i.startY && r.translate >= r.minTranslate()) return n.isTouched = !1, void(n.isMoved = !1)
                } else if (c < i.startX && r.translate <= r.maxTranslate() || c > i.startX && r.translate >= r.minTranslate()) return;
            ...
            n.allowTouchCallbacks && r.emit("touchMove", d), i.previousX = i.currentX, i.previousY = i.currentY, i.currentX = c, i.currentY = u;
            const p = i.currentX - i.startX,
                f = i.currentY - i.startY;
            if (r.params.threshold && Math.sqrt(p ** 2 + f ** 2) < r.params.threshold) return;
            if (void 0 === n.isScrolling) {
                let e;
                r.isHorizontal() && i.currentY === i.startY || r.isVertical() && i.currentX === i.startX ? n.isScrolling = !1 : p * p + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(p)) / Math.PI, n.isScrolling = r.isHorizontal() ? e > s.touchAngle : 90 - e > s.touchAngle)
            }
            if (n.isScrolling && r.emit("touchMoveOpposite", d), void 0 === n.startMoving && (i.currentX === i.startX && i.currentY === i.startY || (n.startMoving = !0)), n.isScrolling || "touchmove" === d.type && n.preventTouchMoveFromPointerMove) return void(n.isTouched = !1);
            ...
            s.oneWayMovement && (m = Math.abs(m) * (a ? 1 : -1), h = Math.abs(h) * (a ? 1 : -1)), i.diff = m, m *= s.touchRatio, a && (m = -m, h = -h);
            const v = r.touchesDirection;
            r.swipeDirection = m > 0 ? "prev" : "next", r.touchesDirection = h > 0 ? "prev" : "next";
            ...
            if (!n.isMoved) {
                ...
                n.allowMomentumBounce = !1, !s.grabCursor || !0 !== r.allowSlideNext && !0 !== r.allowSlidePrev || r.setGrabCursor(!0), r.emit("sliderFirstMove", d)
            }
            if ((new Date).getTime(), n.isMoved && n.allowThresholdMove && v !== r.touchesDirection && g && w && Math.abs(m) >= 1) return Object.assign(i, {
                startX: c,
                startY: u,
                currentX: c,
                currentY: u,
            ...
            r.emit("sliderMove", d), n.isMoved = !0, n.currentTranslate = m + n.startTranslate;
            let y = !0,
                b = s.resistanceRatio;
            if (s.touchReleaseOnEdges && (b = 0), m > 0 ? (g && w && n.allowThresholdMove && n.currentTranslate > (s.centeredSlides ? r.minTranslate() - r.slidesSizesGrid[r.activeIndex + 1] - ("auto" !== s.slidesPerView && r.slides.length - s.slidesPerView >= 2 ? r.slidesSizesGrid[r.activeIndex + 1] + r.params.spaceBetween : 0) - r.params.spaceBetween : r.minTranslate()) && r.loopFix({
                    direction: "prev",
                    setTranslate: !0,
                    activeSlideIndex: 0
                }), n.currentTranslate > r.minTranslate() && (y = !1, s.resistance && (n.currentTranslate = r.minTranslate() - 1 + (-r.minTranslate() + n.startTranslate + m) ** b))) : m < 0 && (g && w && n.allowThresholdMove && n.currentTranslate < (s.centeredSlides ? r.maxTranslate() + r.slidesSizesGrid[r.slidesSizesGrid.length - 1] + r.params.spaceBetween + ("auto" !== s.slidesPerView && r.slides.length - s.slidesPerView >= 2 ? r.slidesSizesGrid[r.slidesSizesGrid.length - 1] + r.params.spaceBetween : 0) : r.maxTranslate()) && r.loopFix({
                    direction: "next",
                    setTranslate: !0,
                    activeSlideIndex: r.slides.length - ("auto" === s.slidesPerView ? r.slidesPerViewDynamic() : Math.ceil(parseFloat(s.slidesPerView, 10)))
                }), n.currentTranslate < r.maxTranslate() && (y = !1, s.resistance && (n.currentTranslate = r.maxTranslate() + 1 - (r.maxTranslate() - n.startTranslate - m) ** b))), y && (d.preventedByNestedSwiper = !0), !r.allowSlideNext && "next" === r.swipeDirection && n.currentTranslate < n.startTranslate && (n.currentTranslate = n.startTranslate), !r.allowSlidePrev && "prev" === r.swipeDirection && n.currentTranslate > n.startTranslate && (n.currentTranslate = n.startTranslate), r.allowSlidePrev || r.allowSlideNext || (n.currentTranslate = n.startTranslate), s.threshold > 0) {
        ...
        function Xe(e) {
            ...
            if ("touchend" === s.type || "touchcancel" === s.type) {
                if (n = [...s.changedTouches].find((e => e.identifier === r.touchId)), !n || n.identifier !== r.touchId) return
            } else {
            ...
            if (t.allowClick) {
                ...
                t.updateClickedSlide(e && e[0] || s.target, e), t.emit("tap click", s), u < 300 && c - r.lastClickTime < 300 && t.emit("doubleTap doubleClick", s)
            }
            if (r.lastClickTime = me(), fe((() => {
            ...
            let p;
            if (r.isTouched = !1, r.isMoved = !1, r.startMoving = !1, p = i.followFinger ? o ? t.translate : -t.translate : -r.currentTranslate, i.cssMode) return;
            ...
            for (let e = 0; e < l.length; e += e < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
                ...
                void 0 !== l[e + t] ? (f || p >= l[e] && p < l[e + t]) && (m = e, h = l[e + t] - l[e]) : (f || p >= l[e]) && (m = e, h = l[l.length - 1] - l[l.length - 2])
            }
            let v = null,
                g = null;
            ...
            if (u > i.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? v : m + y) : t.slideTo(m)), "prev" === t.swipeDirection && (w > 1 - i.longSwipesRatio ? t.slideTo(m + y) : null !== g && w < 0 && Math.abs(w) > i.longSwipesRatio ? t.slideTo(g) : t.slideTo(m))
            } else {
                if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
                t.navigation && (s.target === t.navigation.nextEl || s.target === t.navigation.prevEl) ? s.target === t.navigation.nextEl ? t.slideTo(m + y) : t.slideTo(m) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : m + y), "prev" === t.swipeDirection && t.slideTo(null !== g ? g : m))
            }
        }
        ...
        function Ye() {
            ...
            }), 500)), e.allowSlidePrev = s, e.allowSlideNext = n, e.params.watchOverflow && i !== e.snapGrid && e.checkOverflow()
        }
        ...
        function Ze(e) {
            const t = this;
            Ge(t, e.target), t.params.cssMode || "auto" !== t.params.slidesPerView && !t.params.autoHeight || t.update()
        }
        ...
        const Je = (e, t) => {
            ...
            s && "string" != typeof s && (r[l]("touchstart", e.onDocumentTouchStart, {
                ...
                passive: !0
            }), (n.preventClicks || n.preventClicksPropagation) && s[l]("click", e.onClick, !0), n.cssMode && i[l]("scroll", e.onScroll), n.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Ye, !0) : e[d]("observerUpdate", Ye, !0), s[l]("load", e.onLoad, {
                capture: !0
            }))
        };
        ...
        const nt = {
                ...
                transition: {
                    ...
                    transitionStart: function(e, t) {
                        ...
                        n.cssMode || (n.autoHeight && r.updateAutoHeight(), Fe({
                            swiper: r,
                            runCallbacks: e,
                            direction: t,
                            step: "Start"
                    ...
                    transitionEnd: function(e, t) {
                        ...
                        r.animating = !1, n.cssMode || (r.setTransition(0), Fe({
                            swiper: r,
                            runCallbacks: e,
                            direction: t,
                            step: "End"
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = je.bind(e), e.onTouchMove = We.bind(e), e.onTouchEnd = Xe.bind(e), e.onDocumentTouchStart = Qe.bind(e), t.cssMode && (e.onScroll = Ke.bind(e)), e.onClick = Ue.bind(e), e.onLoad = Ze.bind(e), Je(e, "on")
                    },
                ...
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        const c = (d in i ? i[d] : void 0) || e.originalParams,
                            ...
                            m = c.grabCursor,
                            h = n.enabled;
                        u && !p ? (s.classList.remove(`${n.containerModifierClass}grid`, `${n.containerModifierClass}grid-column`), e.emitContainerClasses()) : !u && p && (s.classList.add(`${n.containerModifierClass}grid`), (c.grid.fill && "column" === c.grid.fill || !c.grid.fill && "column" === n.grid.fill) && s.classList.add(`${n.containerModifierClass}grid-column`), e.emitContainerClasses()), f && !m ? e.unsetGrabCursor() : !f && m && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach((t => {
                        ...
                        const v = c.direction && c.direction !== n.direction,
                            ...
                            w = n.loop;
                        v && r && e.changeDirection(), ge(e.params, c);
                        ...
                        }), h && !y ? e.disable() : !h && y && e.enable(), e.currentBreakpoint = d, e.emit("_beforeBreakpoint", c), r && (g ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !w && b ? (e.loopCreate(t), e.updateSlides()) : w && !b && e.loopDestroy()), e.emit("breakpoint", c)
                    },
        ...
        class it {
            constructor() {
                ...
                1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? t = n[0] : [e, t] = n, t || (t = {}), t = ge({}, t), e && !t.el && (t.el = e);
                const i = ce();
                ...
                }), a.browser = Ae(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
                const o = {};
                a.modules.forEach((e => {
                    e({
                        params: t,
                ...
                const l = ge({}, tt, o);
                return a.params = ge({}, l, st, t), a.originalParams = ge({}, a.params), a.passedParams = ge({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
            ...
            getSlideIndex(e) {
                const {
                    slidesEl: t,
                    params: r
                } = this, n = Me(Se(t, `.${r.slideClass}, swiper-slide`)[0]);
                return Me(e) - n
            }
            ...
            mount(e) {
                ...
                return !s && t.params.createElements && (s = xe("div", t.params.wrapperClass), r.append(s), Se(r, `.${t.params.slideClass}`).forEach((e => {
                    s.append(e)
                }))), Object.assign(t, {
                    el: r,
                    wrapperEl: s,
            ...
            destroy(e, t) {
                ...
                return void 0 === r.params || r.destroyed || (r.emit("beforeDestroy"), r.initialized = !1, r.detachEvents(), n.loop && r.loopDestroy(), t && (r.removeClasses(), s && "string" != typeof s && s.removeAttribute("style"), i && i.removeAttribute("style"), a && a.length && a.forEach((e => {
            ...
            static use(e) {
                return Array.isArray(e) ? (e.forEach((e => it.installModule(e))), it) : (it.installModule(e), it)
            }
        }
        ...
        function ot(e, t, r) {
            ...
            return i || (i = xe("div", n.split(" ")), s.append(i)), i
        }
            ...
            ! function(e) {
                ...
                setTranslate: () => {
                    const {
                        ...
                        slides: n,
                        slidesSizesGrid: s
                    } = t, i = t.params.coverflowEffect, a = t.isHorizontal(), o = t.translate, l = a ? e / 2 - o : r / 2 - o, d = a ? i.rotate : -i.rotate, c = i.depth, u = function(e) {
                    ...
                    for (let e = 0, t = n.length; e < t; e += 1) {
                        ...
                        Math.abs(w) < .001 && (w = 0), Math.abs(g) < .001 && (g = 0), Math.abs(h) < .001 && (h = 0), Math.abs(f) < .001 && (f = 0), Math.abs(m) < .001 && (m = 0), Math.abs(y) < .001 && (y = 0);
                        const b = `translate3d(${w}px,${g}px,${h}px)  rotateX(${u(m)}deg) rotateY(${u(f)}deg) scale(${y})`;
                        if (at(0, t).style.transform = b, t.style.zIndex = 1 - Math.abs(Math.round(p)), i.slideShadows) {
                            ...
                            e || (e = ot("coverflow", t, a ? "left" : "top")), r || (r = ot("coverflow", t, a ? "right" : "bottom")), e && (e.style.opacity = p > 0 ? p : 0), r && (r.style.opacity = -p > 0 ? -p : 0)
                        }
                    }
                },
                setTransition: e => {
        ...
        Object.keys(nt).forEach((e => {
            ...
            r("init", (() => {
                ...
                })), i.observe(t.el)) : (s.addEventListener("resize", o), s.addEventListener("orientationchange", l))
            })), r("destroy", (() => {
                a && s.cancelAnimationFrame(a), i && i.unobserve && t.el && (i.unobserve(t.el), i = null), s.removeEventListener("resize", o), s.removeEventListener("orientationchange", l)
            }))
        }, function(e) {
            let {
                swiper: t,
            ...
            var e = {
                ...
                on: {
                    init: function() {
                        ...
                        var r = this.slides[this.activeIndex];
                        if (r) {
                            var n = this.el.closest(".page");
                            if (n) {
                                n.querySelectorAll(".info-box").forEach((function(e) {
            ...
            function t() {
                ...
                container: ".swiper-container.apps-swiper",
                parent: "#apps"
            }, {
                container: ".swiper-container.stats-swiper",
                parent: "#stats"
            }].forEach((function(t) {
                // Only initialize if we can find both the container and its parent section
                var r = document.querySelector(t.container);
                var parentSection = document.querySelector(t.parent);
                if (r && parentSection) {
                    // Initialize swiper with section-specific settings
                    var s = new it(t.container, {
                        ...e,
                        slidesPerView: "auto",
                        effect: "coverflow",
                        initialSlide: t.parent === "#stats" ? 0 : Math.floor(r.querySelectorAll('.swiper-slide').length / 2)
                    });

                    // Initialize to center or first slide
                    var i = s.slides.length > 0 ? Math.floor(s.slides.length / 2) : 0;
                    setTimeout((function() {
                        s.slideTo(i, 0);
                    }), 300);
                    ...
                    s.on("slideChange", (function() {
                        ...
                        if (activeSlide) {
                            var slideId = activeSlide.getAttribute('data-slide');
                            if (slideId) {
                                parentSection.querySelectorAll(".info-box").forEach((function(infoBox) {
                                    infoBox.classList.toggle("active", infoBox.getAttribute('data-slide') === slideId);
                                }));
                            }
                        }
                    }));

                    // Trigger initial info box display
                    s.emit('slideChange');
                }
